import { checkIsLoggedIn, getUserMission, getUserMissionLevels } from '@/lib/utils/api/my-mission.api';
...
const AchievementPage = async () => {
  ...
  return (
    <div className="flex flex-col gap-3">
      {/* 전체 레벨 5단계 */}
      <strong>OOO님의 혼자 라이프 레벨</strong>
      <MypageProgressBar level={userLevel} />

      {/* 각각의 미션 카테고리 level 현황 */}
      <strong>OOO님의 체크리스트 달성도</strong>
