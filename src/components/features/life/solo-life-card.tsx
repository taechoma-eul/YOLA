...
const SoloLifeCard = ({ id, imageUrls, thumbnail, title, content, date, isMission }: SoloLifeCardType) => {
  return (
    <div className="flex h-full w-full flex-col overflow-hidden rounded border border-gray-300 bg-white text-left text-sm shadow-sm">
      ...
      <div className="aspect-square bg-gray-200">
        <Image src={thumbnail} alt={title} className="h-full w-full object-cover" width={200} height={200} />
      </div>
