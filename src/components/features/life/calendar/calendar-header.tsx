...
const CalendarHeader = ({ calendarMonth, onMoveMonth, onResetToToday }: CalendarHeaderProps) => {
  return (
    <div className="mb-5 flex w-full items-center justify-center">
      {/* 가운데 정렬된 월 + 화살표 */}
      <div className="ml-3 flex items-center justify-center gap-4 sm:ml-[350px] sm:gap-[56px]">
        ...
        <div className="text-center text-base font-semibold leading-6 text-zinc-800 sm:text-xl">
      ...
      <button
        ...
        className="mr-[42px ml-[275px] mt-2 rounded px-2 py-1 text-sm outline outline-1 outline-zinc-800 sm:mt-0"
      >
        TODAY
      </button>
    </div>
