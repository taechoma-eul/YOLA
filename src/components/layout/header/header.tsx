...
const Header = async () => {
  ...
  return (
    <header className="fixed left-0 top-0 z-10 inline-flex h-[60px] w-full flex-col justify-center bg-white outline outline-1 outline-offset-[-1px] outline-secondary-grey-200 md:h-[100px]">
